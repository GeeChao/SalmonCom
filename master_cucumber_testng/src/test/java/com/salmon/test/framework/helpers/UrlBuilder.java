...
public class UrlBuilder {
    ...
    private static final String URL_PROPERTIES = "/PageURL.properties";

    static {
        try {
        	LoadProperties.loadRunConfigProps(RUN_CONFIG_PROPERTIES);
        	LoadProperties.loadURLProps(URL_PROPERTIES);
    ...
    public static void loadURLProps() {
    	LoadProperties.loadURLProps(URL_PROPERTIES);
    }
    ...
    public static void startAtPage(String PageName) {
    	String URL=LoadProperties.getURLProps().getProperty(PageName);
