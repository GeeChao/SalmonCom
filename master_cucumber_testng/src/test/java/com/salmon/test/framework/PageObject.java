...
public class PageObject {
    ...
    */
    ...
    /**
    Scroll down to given element. For chrome.
    */
    public void scrollDownTo(WebElement wb) {
    	((JavascriptExecutor)webDriver).executeScript(
                "arguments[0].scrollIntoView(true);",wb);
    }
    /**
    ...
    **/
    ...
    /**
     * Method to mouse over element 
     */
    
    public void mouseOver(WebElement elementToBeMousedOver){
    	Actions mouseOver = new Actions(webDriver);
		mouseOver.moveToElement(elementToBeMousedOver).perform();
    ...
    public void mouseOverAndClick(WebElement elementToBeClicked){
    	Actions mouseOver = new Actions(webDriver);
		mouseOver.moveToElement(elementToBeClicked).perform();
		elementToBeClicked.click();    	
    }
